...
class ProjectCodeBox extends CodeBox {
    ...
    private static readonly PANEL_TOGGLE_BUTTON_TEXT = "Open/close side panel";
    ...
    constructor(codeBoxElement: HTMLElement, parentCodeBox: ProjectCodeBox | null = null) {
        ...
        folderStructureHeading.innerText = "Folder structure";
        ...
        javaPackagesHeading.innerText = "Java packages";
