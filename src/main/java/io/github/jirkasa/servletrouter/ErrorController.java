...
/**
 * Represents {@link io.github.jirkasa.servletrouter.Controller Controller} that can be set to {@link io.github.jirkasa.servletrouter.Router Router} using {@link io.github.jirkasa.servletrouter.Router#registerErrorController(Class) registerErrorController} method. It then catches any exceptions in the router's handle method.
